...
import getFiles from '@salesforce/apex/AccountController.getFiles';
import deleteDoc from '@salesforce/apex/filePreviewAndDownloadController.deleteDoc'
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { refreshApex } from '@salesforce/apex';
import getFileTypeOptions from '@salesforce/apex/AccountController.getFileTypeOptions';
...
export default class AccountListLWC extends LightningElement {
    ...
    handleRowAction(event) {
        ...
        console.log('hiiiiii : ',selectedRows);
    ...
    filterFiles() {
        if (this.selectedFileType === 'All') {
            ...
            this.filteredFiles = this.originalFiles.filter(file => {
                const titleMatches = file.Title.startsWith(this.selectedFileType.toLowerCase()) || 
                file.Title.startsWith(this.selectedFileType.toUpperCase()) ;
